...
def start_bot():
    while True:
        ...
        print "f.Get a list of people who have liked the recent post of own post\n"
        print "g.Like the recent post of a user\n"
        print "h.Get a list of comments on the recent post of own post\n"
